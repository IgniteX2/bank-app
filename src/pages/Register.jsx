...
import useAuthStore from "../stores/useRegisterUserStore";
import RegisterUserLoader from "../components/cards/RegisterUserLoader";
        ...
        <div 
          ...
          <div 
            ...
            <header 
              ...
              <div className="flex items-center gap-6 font-normal text-[12px] text-[#0D1B2E]">
                <div
            ...
            >
              ...
              {stepForm === 1 && (
                <div
                  ...
                  style={{
                    padding: "16px 24px",
                    boxShadow: "0 0 30px 12px inset rgba(223, 222, 222, 0.6)",
                  }}
                >
                  <div
                  ...
                  <h3 className="text-[#0D1B2E] text-[1rem]/[32px] font-bold">
                    ...
                    <div className="flex flex-col min-h-0 overflow-y-auto no-scrollbar text-[12px]">
                      ...
                      <div style={{ margin: "10px 0" }}>
                        ...
                        {touched.firstName && errorMsg.firstName && (
                          <div className=" w-full text-[10px]/[24px] text-[#DC2626] flex items-center gap-1 justify-end">
                      ...
                      <div style={{ margin: "10px 0" }}>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-1">
                            <div
                              className={`w-26 h-2 rounded-md ${
                                inputValue.userPassword &&
                                hasUpperCase.test(inputValue.userPassword)
                                  ? "bg-[#27A06E]"
                                  : "bg-[#E5E7EB]"
                              }`}
                            />
                            <div
                              className={`w-26 h-2 rounded-md ${
                                inputValue.userPassword &&
                                hasNumber.test(inputValue.userPassword)
                                  ? "bg-[#27A06E]"
                                  : "bg-[#E5E7EB]"
                              }`}
                            />
                            <div
                              className={`w-26 h-2 rounded-md ${
                                inputValue.userPassword &&
                                inputValue.userPassword.length >= 8
                                  ? "bg-[#27A06E]"
                                  : "bg-[#E5E7EB]"
                              }`}
                            />
